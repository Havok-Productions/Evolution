...
public final class TreeCanopyTransitionPolicySmokeTest {
    ...
    public static void main(String[] args) {
        ...
        require(progressiveFloor <
                        TreeCanopyTransitionPolicy.minimumReplacementCanopy(dna),
                "safe shelf peeling must begin before unrestricted cleanup");
        require(TreeCanopyTransitionPolicy.shouldPeelStaleLayer(
                        dna, progressiveFloor, 0),
                "one stale shelf leaf may peel after replacement canopy growth");
        require(!TreeCanopyTransitionPolicy.shouldPeelStaleLayer(
                        dna, progressiveFloor, 1),
                "progressive cleanup must alternate pruning with canopy growth");
        ...
        restored.completeStageGrowthBurst();
