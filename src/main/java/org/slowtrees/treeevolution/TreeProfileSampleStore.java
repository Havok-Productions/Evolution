...
final class TreeProfileSampleStore {
    ...
    Map<TreeSpecies, List<TreeProfileSample>> load(SlowTreesPlugin plugin) {
    ...
    Map<TreeSpecies, List<TreeProfileSample>> saveFromScan(SlowTreesPlugin plugin, StructureScanResult result) {
        Map<TreeSpecies, List<TreeProfileSample>> bySpecies = new EnumMap<>(TreeSpecies.class);
    ...
    private void save(SlowTreesPlugin plugin, Map<TreeSpecies, List<TreeProfileSample>> bySpecies) {
    ...
    private File file(SlowTreesPlugin plugin) {
