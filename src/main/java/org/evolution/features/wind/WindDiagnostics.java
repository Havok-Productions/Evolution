...
final class WindDiagnostics {
    ...
    void saveSoon(EvolutionPlugin plugin, WindConfig config) {
    ...
    void saveAsync(EvolutionPlugin plugin, WindConfig config) {
    ...
    void saveNow(EvolutionPlugin plugin, WindConfig config) {
        plugin.pathDebug().trace(plugin, "wind", "persistence.save-debug.now", "debug.yml");
        save(plugin, config);
    }

    private void save(EvolutionPlugin plugin, WindConfig config) {
