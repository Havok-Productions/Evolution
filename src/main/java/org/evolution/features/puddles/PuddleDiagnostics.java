...
final class PuddleDiagnostics {
    ...
    void saveSoon(EvolutionPlugin plugin, PuddleConfig config) {
    ...
    void saveAsync(EvolutionPlugin plugin, PuddleConfig config) {
    ...
    void saveNow(EvolutionPlugin plugin, PuddleConfig config) {
        plugin.pathDebug().trace(plugin, "puddles", "persistence.save-debug.now", "puddles.debug.yml");
        save(plugin, config);
    }

    private void save(EvolutionPlugin plugin, PuddleConfig config) {
